...
[RegisterOwnedCardKeyword(nameof(Piles), CardDescriptionPlacement = ModKeywordCardDescriptionPlacement.BeforeCardDescription)]
public class TheInsatiableKeyword
{
    ...
    public static readonly CardKeyword Piles = ModContentRegistry.GetQualifiedKeywordId("TheInsatiable", nameof(Piles)).GetModCardKeyword();
}