...
public class InsatiableCharacter : PlaceholderCharacterModel
{
	...
	public override CreatureAnimator GenerateAnimator(MegaSprite controller)
	{
		...
		AnimState val8 = new AnimState("intro_hurt", false);
		AnimState val9 = new AnimState("salivate", false);
		AnimState val10 = new AnimState("attack_thrash", false);
		val2.NextState = val1;
		val3.NextState = val1;
		val4.NextState = val1;
		val7.NextState = val1;
		val8.NextState = val6;
		val9.NextState = val6;
		val10.NextState = val6;
		CreatureAnimator valtotal = new CreatureAnimator(val1, controller);
		valtotal.AddAnyState("Idle", val1);
		valtotal.AddAnyState("Dead", val5);
		valtotal.AddAnyState("Hit", val4, () => !HasNoEscapePower);
		valtotal.AddAnyState("Hit", val8, () => HasNoEscapePower);
		valtotal.AddAnyState("Attack", val3, () => !HasNoEscapePower);
		valtotal.AddAnyState("Attack", val10, () => HasNoEscapePower);
		valtotal.AddAnyState("Cast", val2, () => !HasNoEscapePower);
		valtotal.AddAnyState("Cast", val9, () => HasNoEscapePower);
		valtotal.AddAnyState("NoEscape", val6);
		valtotal.AddAnyState("EatPlayer", val7);
		valtotal.AddAnyState("Salivate", val9);
		return valtotal;
	}
}
